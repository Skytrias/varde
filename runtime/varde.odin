...
// The documentation interface deliberately stays unlike the Showcase. These
// final rules pull it away from component-kit conventions and toward a calm,
// durable reading surface without changing any reader-selected theme palette.
SITE_READER_REFINEMENT_CSS :: `
...
.reference>.entry-group{--region-tint-quiet:2.25%;--region-tint-alternate:4.5%;margin:50px 0 0;padding:0;background:transparent}.entry-group-content{margin-top:17px;padding:0;background:transparent}.entry-group-content>.symbol{--symbol-surface:color-mix(in srgb,var(--accent) var(--region-tint-quiet),var(--surface-raised));position:relative;padding:14px 18px 15px;border:1px solid transparent;background-color:var(--symbol-surface);transition:border-color 110ms cubic-bezier(.22,1,.36,1),box-shadow 130ms cubic-bezier(.22,1,.36,1)}.entry-group-content>.symbol:nth-child(even){--symbol-surface:color-mix(in srgb,var(--accent) var(--region-tint-alternate),var(--surface))}@media(hover:hover){.entry-group-content>.symbol:hover{z-index:1;border-color:color-mix(in srgb,var(--accent) 54%,var(--line));box-shadow:0 6px 8px rgb(0 0 0 / .22)}}.entry-group-content>.symbol:focus-within{z-index:1;border-color:color-mix(in srgb,var(--accent) 54%,var(--line));box-shadow:0 6px 8px rgb(0 0 0 / .22)}:root[data-theme="odin-light"] .reference>.entry-group,:root[data-theme="github-light"] .reference>.entry-group{--region-tint-quiet:3.75%;--region-tint-alternate:6.75%}.entry-group .symbol:first-of-type{padding-top:14px}.symbol+.symbol{margin-top:9px}.symbol .signature{font-size:.96rem;font-weight:600;line-height:1.5;letter-spacing:-.004em}.symbol .signature>:first-child{font-size:clamp(1.12rem,1.62vw,1.32rem);font-weight:780;line-height:1.1;letter-spacing:-.024em}.symbol .source-link{font-size:.7rem}@media(prefers-reduced-motion:reduce){.entry-group-content>.symbol{transition:none}}@media(max-width:620px){.reference>.entry-group{margin-top:42px}.entry-group-content{margin-top:14px}.entry-group-content>.symbol{padding:12px 14px 13px}.symbol+.symbol{margin-top:7px}.symbol .signature{font-size:.92rem}.symbol .signature>:first-child{font-size:1.08rem}}
`
...
SITE_SETTINGS_JS :: `
(() => {
  const root=document.documentElement,key="varde-settings",settings=document.querySelector("#site-settings"),dialog=document.querySelector("#settings-dialog"),close=document.querySelector("#settings-close"),form=document.querySelector("#settings-form"),reset=document.querySelector("#settings-reset"),systemThemeOptions=document.querySelector(".system-theme-options");
  if(!form)return;
